...
<iframe src="https://medium.com/media/abaf5da23151b19703f2d48f9343fcc5" frameborder=0></iframe>
...
<iframe src="https://medium.com/media/ce6ba1c0cff4a6ec5c1d30eac050d9cf" frameborder=0></iframe>
...
<iframe src="https://medium.com/media/c8ea7b1c9e171e328f2f76c4de056b9e" frameborder=0></iframe>
...
Here’s my favorite example of this. Imagine that you have an interface for a CRUD application. You could have one interface that implements the database storage. This is great, but what if the database reads or writes become slow? You could also write a faster implementation that uses [Redis](https://redis.io/) or [Memcached](https://www.memcached.org/) to speed up the response times. The only change you’ll have to make is writing a new interface. There will be no need to update the business logic or anything else.
